...
public class CSV {
	 ...
	 *
	 * @param writer the writer to an underlying CSV.
	 */
	 ...
	 *
	 * @param os the output stream to an underlying CSV.
	 */
	 ...
	 *
	 * @param is the input stream of an underlying CSV.
	 */
	 ...
	 *
	 * @param file CSV file
	 * @param proc the {@link CSVWriteProc} to use for CSV writing
	 */
	 ...
	 * Read CSV using the supplied {@link CSVReadProc}.
	 *
	 * @param reader the reader of an underlying CSV. The reader will not be closed.
	 * @param proc   the {@link CSVReadProc} to use for CSV reading
	 */
	...
	/**
	 * Reads CSV using internal system and reflection to create specific object
	 *
	 * @param reader
	 * @param clazz
	 */
	public <T> Collection<T> read(CSVReader reader, Class clazz) {
		AnnotationProcessor proc = new AnnotationProcessor(clazz);
		reader.read(proc);
	 ...
	 * Read CSV using the supplied {@link CSVReadProc}.
	 *
	 * @param is   the input stream of an underlying CSV. The input stream will be closed.
	 * @param proc the {@link CSVReadProc} to use for CSV reading
	 */
	 ...
	 * Read CSV using the supplied {@link CSVReadProc}.
	 *
	 * @param reader the reader of an underlying CSV. The reader will be closed.
	 * @param proc   the {@link CSVReadProc} to use for CSV reading
	 */
